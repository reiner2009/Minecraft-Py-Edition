rm -r build
rm -r dist
python -m PyInstaller --name 'Minecraft' --windowed --icon 'icon.icns' --add-data "assets:assets" --add-data "data:data" --collect-all net.minecraft net/minecraft/client/Main.py
cp -R icon.icns dist
cd dist
