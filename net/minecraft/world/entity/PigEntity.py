from net.minecraft.world.entity.PathFinderMob import PathFinderMob
import net.minecraft.client.render.world.entity.PigRenderer as PigRenderer
from net.minecraft.world.entity.ai.Goal import RandomStrollAroundGoal
